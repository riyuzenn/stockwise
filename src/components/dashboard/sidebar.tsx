...
export function RightSideBar() {
  ...
  // }
  return (
    <div className="border-l border-black/10 dark:border-white/10 flex bg-[#d3d3d3] dark:bg-[#171717] md:flex-col md:w-40 md:px-4 md:sticky md:top-0 md:h-screen flex-row w-full px-6 py-4 sticky bottom-0 items-center justify-center gap-10 z-50">
